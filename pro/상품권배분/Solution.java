        ...
        for (int i = 0; i < q; ++i) {
            ...
            switch (cmd) {
                ...
                case CMD_ADD:
                    ...
                    if (ret != ans){
                        okay = false;
                        System.out.print("여기서 틀렸습니다.");
                        System.out.println(" 내 add 메서드 결과 : " + ret + " 나와야 하는 결과 : " + ans);
                    }
                    break;
                case CMD_REMOVE:
                    mid = Integer.parseInt(st.nextToken());
                    ...
                    if (ret != ans){
                        okay = false;
                        System.out.print("여기서 틀렸습니다");
                        System.out.println(" 내 remove 메서드 결과 : " + ret + " 나와야 하는 결과 : " + ans);
                    }
                    break;
                case CMD_DISTRIBUTE:
                    ...
                    if (ret != ans){
                        System.out.print("여기서 틀렸습니다.");
                        System.out.println(" 내 distribute 메서드 결과 : " + ret + " 나와야 하는 결과 : " + ans);
                        okay = false;
                    }
                    break;
                default:
